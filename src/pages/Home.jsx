...
const Home = () => {
    return (
        <main className="flex-1 pt-32 pb-20 px-4">
            {/* Hero Section */}
            <div className="max-w-[1200px] mx-auto hero-gradient rounded-[2.5rem] p-8 md:p-16 relative overflow-hidden border border-white/5 shadow-3d">
                ...
                <div className="relative z-10 flex flex-col items-center text-center">
                    <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass border-white/10 text-accent text-sm font-bold mb-8 shadow-glow-accent">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 w-full max-w-3xl mb-12">
                        <div className="glass p-6 rounded-2xl shadow-3d border-accent/20 flex flex-col items-center justify-center group hover:border-accent/50 transition-all">
                        ...
                        <div className="glass p-6 rounded-2xl shadow-3d border-primary/20 flex flex-col items-center justify-center group hover:border-primary/50 transition-all">
                        ...
                        <div className="glass p-6 rounded-2xl shadow-3d border-white/10 flex flex-col items-center justify-center group hover:border-white/30 transition-all">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6">
                        <Link to="/register">
                            <button className="bg-primary text-background-dark font-black px-10 py-4 rounded-xl shadow-glow-primary hover:translate-y-[-2px] transition-all">
                                GET YOUR PASS
                            </button>
                        </Link>
            ...
            {/* Featured Tracks */}
            <section className="max-w-[1200px] mx-auto mt-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-4">
                    {/* Card 1 */}
                    <div className="group relative bg-card-dark rounded-[2rem] p-8 overflow-hidden border border-white/5 shadow-3d hover:border-primary/30 transition-all">
                    ...
                    {/* Card 2 */}
                    <div className="group relative bg-card-dark rounded-[2rem] p-8 overflow-hidden border border-white/5 shadow-3d hover:border-accent/30 transition-all">
                    ...
                    {/* Card 3 */}
                    <div className="group relative bg-card-dark rounded-[2rem] p-8 overflow-hidden border border-white/5 shadow-3d hover:border-white/30 transition-all">
            ...
            {/* Location Section */}
            <section className="max-w-[1200px] mx-auto mt-24 px-4">
                <div className="glass rounded-[2.5rem] p-8 md:p-12 flex flex-col md:flex-row gap-12 items-center border-white/5">
                    ...
                    <div className="md:w-1/2 w-full h-[350px] rounded-3xl overflow-hidden border border-white/10 shadow-3d">
